...
ActiveRecord::Schema.define(:version => 20110803191107) do
  ...
  create_table "user_accesses", :force => true do |t|
    ...
    t.datetime "updated_at",                                  :null => false
    t.integer  "user_id"
    t.boolean  "manage_customers",         :default => false
    t.boolean  "manage_tickets",           :default => false
    t.boolean  "manage_ticket_categories", :default => false
    t.boolean  "manage_agents",            :default => false
  end
